...
struct kstarInJets {
  ...
  void init(o2::framework::InitContext&)
  {
    ...
    const AxisSpec MinvAxis = {400, 0.65, 1.15};
  ...
  PROCESS_SWITCH(kstarInJets, processJetTracks, "process JE Framework", true);
...
{
  return WorkflowSpec{adaptAnalysisTask<kstarInJets>(cfgc)};
};
